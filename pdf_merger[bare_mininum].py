...
cwd_output='D:\\mydocuments' #ouput path of pdf (should be different from cwd to avoid overwritting any pdf there if output filename is same)
...
new_pdf='pdf_merged.pdf' # file name new merged pdf (note: file needs '.pdf' on end)
...
merger.write(cwd_output+'\\'+new_pdf) #save merged files to pdf of specified name (output location is same as "cwd" above)
